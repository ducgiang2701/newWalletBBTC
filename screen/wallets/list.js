...
const WalletsList = () => {
  ...
  console.log('wallets:>>', wallets.concat(false));
  ...
  const renderWalletsCarousel = () => {
    return (
      <View>
        ...
        />
        <View>
          <Text style={[styles.listHeaderText, stylesHook.listHeaderText, {marginLeft:15}]} >November</Text>
          <View style={{flexDirection:'row', marginHorizontal:15, justifyContent:'space-between'}}>
            <View>
              <Text style={{color:'#999999'}}>Incoming</Text>
              <Text>₿ 0.0037 4386</Text>
            </View>
            <View>
              <Text style={{color:'#999999'}}>Outgoing</Text>
              <Text>₿ 0.0001 3376</Text>
            </View>
        ...
        if (dataSource.length === 0 && !isLoading) {
          return (
            <View style={styles.footerRoot} testID="NoTransactionsMessage">
              ...
              >
                <Text style={{ color: "#777777" }}>Today</Text>
              </View>
              <View
                style={{
                  borderBottomWidth: 1,
              ...
              >
                ...
                <View>
                  <Text style={{ fontSize: 15 }}>0.00 001 000 ₿</Text>
